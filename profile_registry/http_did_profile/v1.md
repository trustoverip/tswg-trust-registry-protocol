...
in the DID Document to point to the ecosystem governance framework. The `egfURI` **MUST** be a HTTP resolvable 
...
TODO: accepted TRs representating the EGF should be in the DID Doc! likely another field taking an array. 
